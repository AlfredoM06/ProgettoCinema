--film
INSERT INTO db_cinema.films (archiviato, data_di_uscita, durata, prezzo, scadenza, distribuzione, formato, regista, titolo, img_cover, img_logo, img_poster, lingue, `cast`, descrizione) VALUES (0, '2026-02-25', 114, 6, '26-09-10', 'Paramount Pictures', '3D', 'Kevin Williamson', 'Scream 7', '/img/scream7_cover.jpg', '/img/scream7_logo.png', '/img/scream7_poster.jpg', 'ita', 'Neve Campbell, Courteney Cox, Isabel May, Jasmin Savoy Brown, Mason Gooding', 'quando un nuovo killer Ghostface semina il terrore nella tranquilla città dove Sidney Prescott ha ricostruito la sua vita, i suoi incubi più oscuri diventano realtà: sua figlia diventa il prossimo bersaglio. Determinata a proteggere la sua famiglia, Sidney dovrà affrontare gli orrori del suo passato.');
INSERT INTO db_cinema.films (archiviato, data_di_uscita, durata, prezzo, scadenza, distribuzione, formato, regista, titolo, img_cover, img_logo, img_poster, lingue, `cast`, descrizione) VALUES (0, '2026-07-02', 135, 6, '2026-09-12', 'Universal Pictures', 'IMAX', 'Gareth Edwards', 'Jurassic World – Rebirth', '/img/jurassicworld_cover.jpg', '/img/jurassicworld_logo.png', '/img/jurassicworld_poster.webp', 'ita', 'Scarlett Johansson, Mahershala Ali, Jonathan Bailey', 'Diciassette anni dopo dagli eventi di Jurassic world Dominiion, nel 2027,il pianeta si trova profondamente cambiato. L''ambiente terrestre si è rivelato in gran parte inadatto alla sopravvivenza delle specie preistoriche riportate in vita. La maggior parte dei dinosauri è morta o stata abbattuta; quelli sopravvissuti si rifugiano in poche aree remote, per lo più tropicali, dove le condizioni naturali ricordano i loro antichi habitat, l''accesso alle quali è stato vietato dalle autorità.');
INSERT INTO db_cinema.films (archiviato, data_di_uscita, durata, prezzo, scadenza, distribuzione, formato, regista, titolo, img_cover, img_logo, img_poster, lingue, `cast`, descrizione) VALUES (0, '2026-03-15', 192, 6, '2026-10-12', '20th Century Studios', '4k', 'James Cameron', 'Avatar – La via dell’acqua', '/img/avatar2_cover.jpg', '/img/avatar2_logo.png', '/img/avatar2_poster.png', 'ita', 'Sam Worthington, Zoe Saldaña, Sigourney Weaver', 'ake Sully è il capo del clan degli Omaticaya e ha avuto tre figli con Neytiri: Neteyam, Lo''ak e Tuktirey, detta "Tuk". I due, inoltre, hanno adottato una giovane Na''vi di nome Kiri, concepita inspiegabilmente dall''Avatar della defunta dottoressa Grace Augustine, e si occupano di un ragazzo umano di nome Miles Socorro, detto "Spider", figlio del defunto colonnello Miles Quaritch, nato e sempre vissuto su Pandora con gli scienziati umani e la famiglia Sully, che si comporta come un Na''vi.');
